//added for loop, but this goes too far but works
for (let i=1;i<10;i++){
(async function dome(){
...
if(document.querySelector('body > div:nth-child(18) > div.ivu-modal-wrap > div > div > div.ivu-modal-footer > div > button').classList.contains('ivu-btn-loading')){
	setTimeout(dome, 500);}
	  ...
	  /*
	  await new Promise(r => setTimeout(r, 500));
	  document.querySelector('body > div:nth-child(18) > div.ivu-modal-wrap > div > div > div.ivu-modal-body > div > form > div:nth-child(2) > div > div > label:nth-child(3)').click();//timer
	  await new Promise(r => setTimeout(r, 500));
	  //document.querySelector('body > div:nth-child(18) > div.ivu-modal-wrap > div > div > div.ivu-modal-body > div > form > div:nth-child(1) > div > div > div > div > div > input').click();//droplist;can be dismissed
	  document.querySelector('body > div:nth-child(18) > div.ivu-modal-wrap > div > div > div.ivu-modal-body > div > form > div:nth-child(3) > div:nth-child(1) > div > div > div.ivu-input-number-handler-wrap > a.ivu-input-number-handler.ivu-input-number-handler-up').click();//handler-up child 1
	  await new Promise(r => setTimeout(r, 500));
	  document.querySelector('body > div:nth-child(18) > div.ivu-modal-wrap > div > div > div.ivu-modal-body > div > form > div:nth-child(3) > div:nth-child(3) > div > div > div.ivu-input-number-handler-wrap > a.ivu-input-number-handler.ivu-input-number-handler-up').click();//handler-up child 3
	  */
	  await new Promise(r => setTimeout(r, 500));
