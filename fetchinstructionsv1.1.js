...
//exportfiles: option4 use mainSku only
	//tested 997, it worked,should be no limits
...
//option1 kd: modify spu and fetch; get listAccountNumber: check one and click kd, you'll see; seems the only way is to use spu , can't use categoryIds;
...
//pricecalculator publish part begins -------------------------------------------------------------------------
