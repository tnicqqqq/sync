// ==UserScript==
// @name         interContinentalPanelv1.8
...
opaddproducts.addEventListener('click', functionopaddproducts(marketdomain));
opinventory.addEventListener('click', functionopinventory(marketdomain));
opaccounthealth.addEventListener('click', functionopaccounthealth(marketdomain));
opperformancenotification.addEventListener('click', functionopperformancenotification(marketdomain));
opcampaignmanager.addEventListener('click', functionopcampaignmanager(marketdomain));
opmanagepromotions.addEventListener('click', functionopmanagepromotions(marketdomain));
opinventoryrepor.addEventListener('click', functionopinventoryrepor(marketdomain));
opbulkupload.addEventListener('click', functionopbulkupload(marketdomain));
opmanageoders.addEventListener('click', functionopmanageoders(marketdomain));
opvouchers.addEventListener('click', functionopvouchers(marketdomain));
