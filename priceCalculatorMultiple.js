//works , but doesn't wait for response
const articleNumbers = [
  "9SD505790-588",
  //"9SD514559-A","4NB108673-PK","4NB108673-RG","4NB108673-GD","5AC616380-A","2SS323377-S","2SS323377-L","4NB802858-BL","4NB802858-W","4NB802858-R","7HH404572","9EE700242-OR","9EE700242-BN","9EE700242-R","9EE700242-DR","9EE700242-RB","9EE700242-NB","9EE700242-KH","9EE700242-GY","9EE700242-SP"
  // ... more article numbers
];

const promises = articleNumbers.map(articleNumber => {
  const requestBody = {
  ...
  return fetch("http://10.100.1.1/sale-extra/priceCalculator", {
	"headers": {
  ...
  .catch(error => {
    console.error(`Error fetching data for ${articleNumber}:`, error);
