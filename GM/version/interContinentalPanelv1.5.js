// ==UserScript==
// @name         interContinentalPanelv1.5
...
tdfr.addEventListener('click', functiontdfr);
...
tdde.addEventListener('click', functiontdde);
...
tdit.addEventListener('click', functiontdit);
...
tdes.addEventListener('click', functiontdes);
...
tdnl.addEventListener('click', functiontdnl);
...
tdca.addEventListener('click', functiontdca);
...
tdmx.addEventListener('click', functiontdmx);
